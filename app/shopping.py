...
def format_usd(my_price):
    """
    Formats a number as USD with dollar sign and two decimals (and also thousans separator)
...
def lookup_product(product_id, all_products):
    ...
    Params : 
        ...
        all_products (list or dict) each dict should have "id", "name", "department", "aisle", and "price" attribute
    """
